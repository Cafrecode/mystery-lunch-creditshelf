...
RUN set -ex \
  ...
  && DATABASE_URL=postgres://postgres@app.cafrecode.com.com:5432/mystery_lunch_creditshelf_production \
  SECRET_KEY_BASE=a7dc9cae15a678cbc5690d1185468f98 \
